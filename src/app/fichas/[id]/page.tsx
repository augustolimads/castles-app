...
import { useSpellsStore } from "@/modules/fichas/stores/spell";
...
export default function SheetDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    useEffect(() => {
        ...
        const saveInterval = setInterval(() => {
            if (character.id) {
                saveCharacter(spells, inventory);
            }
        }, 5 * 60 * 1000); // 5 minutos
    ...
    }, [id, character.id, spells, inventory]);
    ...
    return (
        <main>
            ...
            >
                <div className="col-start-1 row-start-1 md:row-span-1">
                    <SidebarTrigger />
                </div>
                <div
                    id="characterName"
                    className="row-start-1 col-start-2 md:col-start-2 col-span-3 md:col-span-4 row-span-2 self-center -mr-3.5"
                >
                    <CharacterName />
                </div>
                <div
                ...
                <div
                    className="hidden lg:block col-start-2 col-span-3 row-start-7 row-span-7 mb-4 card"
                >
                    <Combat />
                </div>
                <div
