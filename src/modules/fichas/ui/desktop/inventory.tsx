...
function Inventory() {
    ...
    useEffect(() => {
      ...
      const coinWeight =
          Math.floor(character.treasure.platinum / 160) +
    ...
    return (
      <div
          id="Inventory"
          className="flex flex-col gap-4 h-full pb-12 justify-between"
      >
          <div className="flex flex-col gap-2 flex-1">
              ...
              action: modeToggleDeleteItem,
                  ...
                  cart={
                      character.id
                          ? {
                              title: "Comprar para este personagem",
                              action: () =>
                                  router.push(`/itens?characterId=${character.id}`),
                          }
                          : undefined
                  }
                  search={{
          ...
          <div className="grid grid-cols-2 gap-4">
              ...
              <div id="encumbrance">
                  ...
                  <div className="text-left text-xs flex flex-col gap-1">
                      <p>
                          <span className="font-bold">Moedas:</span> 160 moedas = 1 EV
                      </p>
                      <p>
                          <span className="font-bold">Pesado:</span> ND+2 DES, movimento
                          -10ft (-3m)
                      </p>
                      <p>
                          <span className="font-bold">Muito Sobrecarregado:</span> ND DES
                          falha, CA perde DES
                      </p>
                  </div>
              </div>
